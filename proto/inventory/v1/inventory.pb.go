...
const file_inventory_v1_inventory_proto_rawDesc = "" +
	...
	"\fProductInput\x12\x1b\n" +
	"\x03sku\x18\x01 \x01(\tB\t\xfaB\x06r\x04\x10\x01\x18@R\x03sku\x12\x1e\n" +
	"\x04name\x18\x02 \x01(\tB\n" +
	"\xfaB\ar\x05\x10\x01\x18\xff\x01R\x04name\x12*\n" +
	"\vdescription\x18\x03 \x01(\tB\b\xfaB\x05r\x03\x18\xa0 R\vdescription\x12(\n" +
	"\vprice_cents\x18\x04 \x01(\x03B\a\xfaB\x04\"\x02(\x00R\n" +
	"priceCents\x12-\n" +
	"\rcurrency_code\x18\x05 \x01(\tB\b\xfaB\x05r\x03\x98\x01\x03R\fcurrencyCode\x12\x1b\n" +
	"\tis_active\x18\x06 \x01(\bR\bisActive\"\x9e\x03\n" +
	"\fProductPatch\x129\n" +
...
var file_inventory_v1_inventory_proto_depIdxs = []int32{
	...
	30, // 4: inventory.v1.ProductPatch.sku:type_name -> google.protobuf.StringValue
	30, // 5: inventory.v1.ProductPatch.name:type_name -> google.protobuf.StringValue
	30, // 6: inventory.v1.ProductPatch.description:type_name -> google.protobuf.StringValue
	31, // 7: inventory.v1.ProductPatch.price_cents:type_name -> google.protobuf.Int64Value
	30, // 8: inventory.v1.ProductPatch.currency_code:type_name -> google.protobuf.StringValue
	32, // 9: inventory.v1.ProductPatch.is_active:type_name -> google.protobuf.BoolValue
	1,  // 10: inventory.v1.CreateProductRequest.product:type_name -> inventory.v1.ProductInput
	0,  // 11: inventory.v1.CreateProductResponse.product:type_name -> inventory.v1.Product
	28, // 12: inventory.v1.UpdateProductRequest.product_id:type_name -> orderhub.common.v1.UUID
	2,  // 13: inventory.v1.UpdateProductRequest.patch:type_name -> inventory.v1.ProductPatch
	0,  // 14: inventory.v1.UpdateProductResponse.product:type_name -> inventory.v1.Product
	28, // 15: inventory.v1.DeleteProductRequest.product_id:type_name -> orderhub.common.v1.UUID
	28, // 16: inventory.v1.GetProductRequest.product_id:type_name -> orderhub.common.v1.UUID
	0,  // 17: inventory.v1.GetProductResponse.product:type_name -> inventory.v1.Product
	28, // 18: inventory.v1.ListProductsRequest.vendor_id:type_name -> orderhub.common.v1.UUID
	0,  // 19: inventory.v1.ListProductsResponse.products:type_name -> inventory.v1.Product
	28, // 20: inventory.v1.BatchGetProductsRequest.product_ids:type_name -> orderhub.common.v1.UUID
	0,  // 21: inventory.v1.BatchGetProductsResponse.products:type_name -> inventory.v1.Product
	28, // 22: inventory.v1.Stock.product_id:type_name -> orderhub.common.v1.UUID
	29, // 23: inventory.v1.Stock.updated_at:type_name -> google.protobuf.Timestamp
	28, // 24: inventory.v1.GetStockRequest.product_id:type_name -> orderhub.common.v1.UUID
	14, // 25: inventory.v1.GetStockResponse.stock:type_name -> inventory.v1.Stock
	28, // 26: inventory.v1.SetStockRequest.product_id:type_name -> orderhub.common.v1.UUID
	14, // 27: inventory.v1.SetStockResponse.stock:type_name -> inventory.v1.Stock
	28, // 28: inventory.v1.AdjustStockRequest.product_id:type_name -> orderhub.common.v1.UUID
	14, // 29: inventory.v1.AdjustStockResponse.stock:type_name -> inventory.v1.Stock
	28, // 30: inventory.v1.ReserveItem.product_id:type_name -> orderhub.common.v1.UUID
	28, // 31: inventory.v1.ReserveRequest.order_id:type_name -> orderhub.common.v1.UUID
	21, // 32: inventory.v1.ReserveRequest.items:type_name -> inventory.v1.ReserveItem
	28, // 33: inventory.v1.ReserveOkItem.product_id:type_name -> orderhub.common.v1.UUID
	28, // 34: inventory.v1.ReserveFailedItem.product_id:type_name -> orderhub.common.v1.UUID
	23, // 35: inventory.v1.ReserveResponse.ok_items:type_name -> inventory.v1.ReserveOkItem
	24, // 36: inventory.v1.ReserveResponse.failed_items:type_name -> inventory.v1.ReserveFailedItem
	28, // 37: inventory.v1.ReleaseRequest.order_id:type_name -> orderhub.common.v1.UUID
	28, // 38: inventory.v1.ConfirmRequest.order_id:type_name -> orderhub.common.v1.UUID
	3,  // 39: inventory.v1.InventoryService.CreateProduct:input_type -> inventory.v1.CreateProductRequest
	5,  // 40: inventory.v1.InventoryService.UpdateProduct:input_type -> inventory.v1.UpdateProductRequest
	8,  // 41: inventory.v1.InventoryService.GetProduct:input_type -> inventory.v1.GetProductRequest
	10, // 42: inventory.v1.InventoryService.ListProducts:input_type -> inventory.v1.ListProductsRequest
	7,  // 43: inventory.v1.InventoryService.DeleteProduct:input_type -> inventory.v1.DeleteProductRequest
	12, // 44: inventory.v1.InventoryService.BatchGetProducts:input_type -> inventory.v1.BatchGetProductsRequest
	15, // 45: inventory.v1.InventoryService.GetStock:input_type -> inventory.v1.GetStockRequest
	17, // 46: inventory.v1.InventoryService.SetStock:input_type -> inventory.v1.SetStockRequest
	19, // 47: inventory.v1.InventoryService.AdjustStock:input_type -> inventory.v1.AdjustStockRequest
	22, // 48: inventory.v1.InventoryService.Reserve:input_type -> inventory.v1.ReserveRequest
	26, // 49: inventory.v1.InventoryService.Release:input_type -> inventory.v1.ReleaseRequest
	27, // 50: inventory.v1.InventoryService.Confirm:input_type -> inventory.v1.ConfirmRequest
	4,  // 51: inventory.v1.InventoryService.CreateProduct:output_type -> inventory.v1.CreateProductResponse
	6,  // 52: inventory.v1.InventoryService.UpdateProduct:output_type -> inventory.v1.UpdateProductResponse
	9,  // 53: inventory.v1.InventoryService.GetProduct:output_type -> inventory.v1.GetProductResponse
	11, // 54: inventory.v1.InventoryService.ListProducts:output_type -> inventory.v1.ListProductsResponse
	33, // 55: inventory.v1.InventoryService.DeleteProduct:output_type -> google.protobuf.Empty
	13, // 56: inventory.v1.InventoryService.BatchGetProducts:output_type -> inventory.v1.BatchGetProductsResponse
	16, // 57: inventory.v1.InventoryService.GetStock:output_type -> inventory.v1.GetStockResponse
	18, // 58: inventory.v1.InventoryService.SetStock:output_type -> inventory.v1.SetStockResponse
	20, // 59: inventory.v1.InventoryService.AdjustStock:output_type -> inventory.v1.AdjustStockResponse
	25, // 60: inventory.v1.InventoryService.Reserve:output_type -> inventory.v1.ReserveResponse
	33, // 61: inventory.v1.InventoryService.Release:output_type -> google.protobuf.Empty
	33, // 62: inventory.v1.InventoryService.Confirm:output_type -> google.protobuf.Empty
